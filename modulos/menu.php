    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <a id="ahome" class="brand" href="./"><img src="<?php echo Dropbox; ?>home/logo.png"></a>
                <div class="nav-collapse collapse" style="margin-top: 1em;">
                    <ul class="nav">
                    ...
                    <ul class="nav pull-right" style="margin-right: 5%;">
                        ...
                        <li><a id="twitter" href="http://twitter.com/altiviaot" rel="popover" data-placement="bottom" data-delay="show: 5000, hide: 100" data-html="true"  data-content="<?php if (file_exists("modulos/tweets.php")){ include('modulos/tweets.php'); } ?>" class="pop"><img src="<?php echo Dropbox; ?>menu/twitter.png" alt="" width="24"></a></li>
                        <!-- <li><a id="rss" href=""><button id="tools" class="btn btn-warning"><img src="<?php echo Dropbox; ?>Altiviaot/web/menu/rss.png" alt="" width="20"></button></a></li> -->
                    </ul>
                </div>
            </div>
        </div>
